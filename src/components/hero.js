        ...
        <>
            <article className="h-[500px] relative z-1">
                ...
                <motion.div
                    ...
                    className="w-2/5 text-xl font-title text-center  absolute z-5 right-0 top-10 hover:shadow-lg hover:shadow-darkColor hover:border-3 hover:rounded-lg hover:border-darkColor rounded-b-lg p-2"
                >
                    ...
                    <a href="mailto:silje.a.paldrup@gmail.com?body=Our%20company%20is%20very%20interested%20in%20having%20you%20as%20an%20intern!&subject=Internship!" target="_blank"><motion.p whileTap={{ scale: 0.95 }}>Interested?</motion.p></a>
                </motion.div>
                <motion.div
                    whileTap={{ scale: 0.95 }}
                    className=" absolute bottom-4 left-0 right-0 p-3 text-center mx-auto scroll-smooth">
